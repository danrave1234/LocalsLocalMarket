...
import { createShopRequest, fetchCategories } from '../api/shops.js'
...
export default function ShopCreatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(errorInfo.message || 'Failed to create shop')
      ...
      <div className="shop-edit-header">
        <div className="header-content">
          ...
          <div className="header-text">
            ...
            <p className="page-subtitle">Set up your shop information and settings</p>
          </div>
        </div>
